...
fn default_system_prompt() -> String {
    [
        ...
        "Prefer safe, read-first workflows before mutating actions. Do not overwrite or revert user changes unless explicitly asked.",
        ...
        "Create commits only when the user asks. After making changes, run the most relevant narrow validation when feasible and report what was verified.",
    ]
    .join(" ")
}
