...
#[test]
fn web_search_presentation_uses_unknown_action_metadata_without_query_fallback() {
    let presentation = web_search_presentation(
        "ignored query",
        Some(&WebSearchAction::Unknown {
            raw_type: Some("mystery".to_string()),
            raw: None,
        }),
        None,
        None,
    ...
    assert_eq!(presentation.detail, "mystery");
}
