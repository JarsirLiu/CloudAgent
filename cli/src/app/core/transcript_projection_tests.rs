...
fn scrollback_snapshot_keeps_only_committed_cells() {
    ...
    owner.push_live_cell(crate::ui::widgets::history_cell::HistoryCell::reasoning(
        "Reasoning",
        "thinking",
    ));
...
fn snapshot_revisions_track_committed_and_live_updates_independently() {
    ...
    owner.push_committed_cell(crate::ui::widgets::history_cell::HistoryCell::user("hello"));
